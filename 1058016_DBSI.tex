...
q13 & 3.828             & 2.5824              & 1.48234201       \\ \hline
q14 & 0.9798            & 0.8059              & 1.2157836        \\ \hline
\end{tabular}
\caption{Time took to process and evaluate the query by the model answer and the new query plan in ms on the data set LUBM-001-mat.ttl. The new plan achieves 1000\% speed up in average on the 14 queries.}
\end{table}
